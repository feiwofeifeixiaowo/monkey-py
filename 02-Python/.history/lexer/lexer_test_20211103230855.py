...
class TestNextToken(unittest.TestCase):
    def test_next_token(self):
        ...
        for i, tt in enumerate(tests):
            print('=================index: ', i)
            tok = l.next_token()
            # self.assertEqual(tok.token_type.type_name, tt.exp_token_type.type_name, 'token_type wrong, expected {}, got {}'.format(tok.token_type.type_name, tt.exp_token_type.type_name))
